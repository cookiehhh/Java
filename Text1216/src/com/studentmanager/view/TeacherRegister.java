...
public class TeacherRegister extends JFrame implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getActionCommand().equals("确定")) {
			Teacheruser tear = new Teacheruser();
			tear.setUsername(usernamef.getText().trim());
			tear.setPassword(passwordf.getText().trim());
			Manager.insertTear(tear);

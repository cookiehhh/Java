...
public class Borrow extends Panel implements ActionListener{
	/**
	 * 
	 */
	...
	public void actionPerformed(ActionEvent e) {
					    	...
					    	if (newstock>=0) {
					    		try {
							    	...
							    	if (len>0) {
							    		...
							    		JOptionPane.showMessageDialog(this, "没有此书，请重新输入！", "提示消息", JOptionPane.WARNING_MESSAGE);
							    	}
								} catch (Exception e1) {
									e1.printStackTrace();	
								}
								...
								try {   
							        ...
							        JOptionPane.showMessageDialog(this,"借阅成功！","提示消息",JOptionPane.WARNING_MESSAGE);
							    } catch (Exception e1) {
							        e1.printStackTrace();		        
							    }
							}else {
								JOptionPane.showMessageDialog(this, "库存为零，请重新输入！", "提示消息", JOptionPane.WARNING_MESSAGE);
							}
						}else{
							JOptionPane.showMessageDialog(this, "没有本书，请重新输入！", "提示消息", JOptionPane.WARNING_MESSAGE);
						}
		...
		{
			JOptionPane.showMessageDialog(this , "请输入要查询的编号","提示消息",JOptionPane.WARNING_MESSAGE);
		}
	}
}
